...
urlpatterns = [
    ...
    path("ods/<int:pk>/rimuovi-tecnico/", views.ods_rimuovi_tecnico,    name="ods_rimuovi_tecnico"),
    ...
    path("condomini/<int:pk>/rimuovi-tecnico/", views.condominio_rimuovi_tecnico, name="condominio_rimuovi_tecnico"),
