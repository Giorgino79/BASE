...
from .reports_analysis.ricavi import RicaviReport, RicaviPerTipoReport
from .reports_analysis.costi import CostiReport
from .reports_analysis.margini import MarginiReport
...
def dashboard(request):
    ...
    return render(request, "core/analysis/dashboard.html", ctx)
...
def costi_servizi(request):
    ...
    return render(request, "core/analysis/costi_servizi.html", {
        "rows":    rows,
        "totali":  totali,
        "data_da": data_da.strftime("%Y-%m-%d"),
        "data_a":  data_a.strftime("%Y-%m-%d"),
