...
urlpatterns = [
    ...
    path('passaggi-cassa/<int:pk>/modifica/', views.passaggio_cassa_update, name='passaggio_cassa_update'),
    path('passaggi-cassa/<int:pk>/elimina/',  views.passaggio_cassa_delete, name='passaggio_cassa_delete'),
